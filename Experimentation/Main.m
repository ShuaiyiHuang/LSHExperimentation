...
% Figure1,SIFT Case1
fprintf('Figure 1...');
Param=struct('qpath',siftq,'dpath',siftb,'qNum',10,'dNum',100,'dHam',30,...
    'knn',6,'tNum',10,'varname','dHam','varmin',20,'varmax',130,'vargap',10);
StartExperiment(Param);
% Figure2,SIFT Case2
fprintf('Figure 2...');
Param=struct('qpath',siftq,'dpath',siftb,'qNum',100,'dNum',1000,'dHam',30,...
'knn',6,'tNum',10,'varname','dHam','varmin',20,'varmax',130,'vargap',10);
StartExperiment(Param);
% % Figure3,GIST Case1
...
%     'knn',8,'tNum',10,'varname','knn','varmin',1,'varmax',20,'vargap',1);
% StartExperiment(Param);
% % Figure14,GIST Case
% Param=struct('qpath',gistq,'dpath',gistb,'qNum',100,'dNum',500,'dHam',256,...
%     'knn',6,'tNum',10,'varname','qNum','varmin',1,'varmax',40,'vargap',2);
% StartExperiment(Param);
% 
% 
% 
